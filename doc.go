...
//go:generate mockgen -package mock -destination mock/storage.go github.com/leenux/goka/storage Storage
...
//go:generate mockgen -package mock -destination mock/kafka.go github.com/leenux/goka/kafka Consumer,TopicManager,Producer
